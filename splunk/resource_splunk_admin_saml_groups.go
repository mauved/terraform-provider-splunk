...
func samlGroupResourceObjectHandlerComposer() func(*entry.SAMLGroup) resource.Sync {
	return func(group *entry.SAMLGroup) resource.Sync {
		return resource.ComposeSync(
